...
The penultimate relationship we will look at, before creating a model that controls for all our variables, is that between education and wellbeing. Our model showed that, compared to respondents with higher degrees, the difference in wellbeing with those with degrees and, strangely, AS-levels were not statistically significant. However, the differences in wellbeing between respondents with higher degrees and all other qualifications *were* statistically significant. Interestingly, the magnitude of the effect of respondents who had gone through higher education (e.g. a teaching qualification but not a pgce) and those with GCSEs was similar (-0.24682 and -0.22977 respectively), alongside a smaller magnitude of effect for respondents with A-levels (only -0.10773). The largest effect magnitudes came from respondents with CSEs and ‘Other school certificates’, with effect magnitudes of -0.41846 and -0.52835 respectively. The wellbeing scores for these education levels are included in the following graph.
...
Finally, we evaluated the relationship between wellbeing and sex. As our descriptive analysis suggests, men have a higher wellbeing score than women. Our models allows us to see that the difference between the two is statistically significant at the 99.9% confidence interval (p < 0.001), and the difference is shown in the below graph.
...
Our results show that each year is statistically different at least at the 95% confidence level, and that the magnitude of this effect varies, though is fairly small in 2010 and 2015.
...
This table shows us that aside from in 2013, there is no statistically significant difference between the effect sex has on wellbeing over time. As for 2013, this difference is only significant at the 90% confidence level, and the effect is fairly small. Consequently, we can conclude that changes in wellbeing over time are not a result of being one sex or the other, rather that there is a consistent difference in wellbeing between the sexes.
...
Our analysis shows us that, for the most part, there is not an effect in wellbeing for respondents with different qualifications that changes over time. However, there are three statistically significant exceptions to this. In 2011, those with ‘CSE’s had a wellbeing that was lower by 1.723, significant at a 90% confidence level. Further, in 2014, those same respondents had a wellbeing that was lower by 2.268, significant at a 95% confidence level. Finally, respondents with ‘Other school certificates’ had a wellbeing that was lower by 2.148, significant at a 95% confidence level, in 2015. Therefore, barring these exceptions (where the difference in wellbeing is greater), the difference in wellbeing between those with the different qualifications is consistent.
...
Surprisingly, individual changes in income are not met with a statistically significant increase in wellbeing. Perhaps this is because a large increase in income is necessary for an impact to be made on an individuals’ life, for example so an individual can move to a nicer part of the country, and so perhaps any change in wellbeing due to an increase in income for individuals takes longer to come into effect that we are able to see in our seven years of data.
...
EVALUATE CHANGES (WHETHER THEY MAKE ANY DISCERNIBLE DIFFERENCE OR NOT) FROM LAST SECTION (e.g. add bit about age having a tiny difference in wellbeing score despite being statistically significant) – also add (p < 0.05) for statistical significance etc. - edit down descriptive section (remove attempted explanations, keep for discussion/conclusion)